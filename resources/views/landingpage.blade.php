...
<html lang="en">
    <head>
        ...
        <link href="/landingpage/css/templatemo-first-portfolio-style.css" rel="stylesheet">
...
-->
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <div class="d-lg-flex align-items-center d-none ms-auto">
                        @auth
                        <i class="navbar-icon bi-telephone-plus me-3"></i>
                        <a class="custom-btn btn" href="/dashboard">
                            Dashboard
                        </a>
                        @else
                        <i class="navbar-icon bi-telephone-plus me-3"></i>
                        <a class="custom-btn btn" href="/login">
                            Login
                        </a>
                        @endauth
                    </div>
        ...
        <script src="/landingpage/js/click-scroll.js"></script>
